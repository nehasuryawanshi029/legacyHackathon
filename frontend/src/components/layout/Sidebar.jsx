...
import {
  ...
  Zap, Brain, ShieldAlert, Sparkles
} from 'lucide-react'
import { useAtlantis } from '../../context/AtlantisContext'

export default function Sidebar() {
  const location = useLocation()
  const { readiness, topics, sessions } = useAtlantis()
  ...
  return (
    <aside className="w-64 bg-slate-950/90 border-r border-teal-500/20 text-slate-200 flex flex-col justify-between hidden md:flex shrink-0 min-h-screen sticky top-0 backdrop-blur-md z-30">
      <div>
        {/* Brand Header */}
